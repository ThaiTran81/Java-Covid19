...
public class NecessityEditPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
        gridBagConstraints.insets = new java.awt.Insets(0, 0, 10, 0);
        panelInput.add(comboCate, gridBagConstraints);
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        gridBagConstraints.insets = new java.awt.Insets(0, 0, 10, 0);
        panelInput.add(lbCate, gridBagConstraints);
    ...
    void updateToDB() {
        try {
            ...
            Object params[] = {model.getName(), model.getLimit(), model.getPrice(), model.getTime_limit(),model.getType(), model.getId()};
